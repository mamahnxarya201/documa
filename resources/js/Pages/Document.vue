...
const openEditModal = () => editModal.value = true
const cancelEditModal = () => cancelEdit.value = true
</script>
                            ...
                            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <div id="app" class="container mx-auto">
                                        <table class="w-full">
                                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 p-3">
                                                <th>Name</th>
                                                <th>Status</th>
                                                <th>Tags</th>
                                                <th>Action</th>
                                            ...
                                            <tbody>
                                                <template v-for="(item, key) in items" :key="key">
                                                    <tr :class="trStyling(key)">
                                                        <td>test gfdsgsdsl</td>
                                                        <td>test</td>
                                                        <td>test</td>
                                                        <td>
                                                            <div class="flex w-full justify-center">
                                                                <div class="font-medium text-blue-600 dark:text-blue-500 hover:underline" @click="openEditModal">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10"/>
                                                                    </svg>
                                                                </div>
                                                                <div class="font-medium text-blue-600 dark:text-blue-500 hover:text-gray-400">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    ...
                                                    <tr>
                                                        <td v-if="item.openDropdown" colspan="5">
                                                                ...
                                                                <div class="grid grid-cols-3 gap-y-8 gap-x-4">
                                                                    ...
                                                                    <div class="flex flex-col">
                                                                        ...
                                                                        <div class="flex flex-row">
                                                                            ...
                                                                            <ArrowTopRightOnSquareIcon class="size-4 ml-2 text-blue-600 dark:text-blue-500 hover:underline" @click="openEditModal"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex flex-col">
