...
use App\Actions\Documa\Contracts\ICrudAction;

class DocumentAction implements ICrudAction
{
    ...
    public function getListAllDocument(): array
    {
        return [
            [
                'name' => 'Document 1',
                'status' => 'Approved by Working Group',
                'tags' => ['NDA'],
                'openDropdown' => false
            ],
            [
    ...
    public function getDetailDocumentById(int $documentId)
    {
        $mockData = [
            [
                'id' => 1,
        ...
        return $mockData[array_search($documentId, array_column($mockData, 'id'))];
